...
/// Wire protocol for the RivenAgent broker.
///
...
///
/// Default broker socket path: `~/Library/Application Support/Riven/agent.sock`
...
public enum AgentIPC {
    ...
    public static var defaultSocketURL: URL {
        ...
        return base.appendingPathComponent("Riven", isDirectory: true).appendingPathComponent("agent.sock")
    }
