# Riven shell integration — plugin loader.
#
# Sources the vendored plugins in `$RIVEN_INTEGRATION_DIR/plugins/`.
...
if [[ -r "$RIVEN_INTEGRATION_DIR/plugins/zsh-autosuggestions.zsh" ]]; then
  ...
  source "$RIVEN_INTEGRATION_DIR/plugins/zsh-autosuggestions.zsh"
fi
