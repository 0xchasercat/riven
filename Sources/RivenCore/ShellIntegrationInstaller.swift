...
/// Installs and uninstalls Riven's optional zsh shell integration.
///
...
///    `~/.config/riven/shell/` and appends a fenced source block to
///    `~/.zshrc` so the user's interactive shells pick up Riven's
...
public struct ShellIntegrationInstaller: Sendable {
    public enum InstallError: Error, CustomStringConvertible {
        ...
        public var description: String {
            switch self {
            case .missingBundleResources:
                return "Riven's shell-integration resources are missing from the app bundle"
    ...
    public static let beginMarker = "# >>> Riven shell integration >>>"
    public static let endMarker   = "# <<< Riven shell integration <<<"
    ...
    public init(
        ...
        self.destinationDirectory = destinationDirectory
            ?? home.appendingPathComponent(".config/riven/shell", isDirectory: true)
    ...
    public func isInstalled() -> Bool {
        ...
        let entry = destinationDirectory.appendingPathComponent("riven.zsh")
    ...
    private func renderedZshrcBlock() -> String {
        let entry = destinationDirectory.appendingPathComponent("riven.zsh").path
        return """
        \(Self.beginMarker)
        # Riven provides an optional zsh integration. Sourced only when
