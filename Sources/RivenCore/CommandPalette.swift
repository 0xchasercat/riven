...
public enum CommandAction: String, Codable, Sendable {
    ...
    case cycleTheme
    /// Install Riven's optional zsh shell integration (Z-3). Idempotent
    ...
    /// Remove Riven's zsh shell integration. Leaves the user's
...
public struct Command: Equatable, Codable, Sendable, Identifiable {
    ...
    public static let bentoBuiltIns: [Command] = [
        ...
        Command(id: .installShellIntegration, group: "Shell", title: "Install Riven shell integration"),
        Command(id: .uninstallShellIntegration, group: "Shell", title: "Uninstall Riven shell integration")
