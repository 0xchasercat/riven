...
struct ScrollbackPeekView: View {
    ...
    /// (BentoRootController) — the peek view itself doesn't know how
            ...
            ScrollViewReader { proxy in
                ...
                .onAppear {
                    ...
                    DispatchQueue.main.async {
                        withAnimation(BentoMotion.standard) {
    ...
    private func row(for line: (number: Int, text: String)) -> some View {
        ...
        HStack(alignment: .firstTextBaseline, spacing: 0) {
            Text("\(line.number)")
                .font(BentoType.mono(10, weight: isFocus ? .semibold : .regular))
            ...
            Text(stripAnsi(line.text))
                .font(BentoType.mono(12, weight: isFocus ? .semibold : .regular))
                .foregroundStyle(Color(hex: theme.chrome.text.hex))
