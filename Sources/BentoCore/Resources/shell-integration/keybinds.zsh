# Bento shell integration — keyboard bindings.
#
...
# .zshrc after sourcing Bento — we don't override their personal
# config.
bindkey -e
...
# keybinds.zsh — which it does, per the order in bento.zsh.
