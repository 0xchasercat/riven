...
public struct ThemeSpec: Equatable, Codable, Sendable, Identifiable {
    ...
    /// what give Bento its signature "compartment wall" look (6 pt
    ...
    public static let builtIns: [ThemeSpec] = [
        ThemeSpec(
            ...
            // Bento's signature compartment-wall look: thick dividers, mild
...
public struct ThemeChrome: Equatable, Codable, Sendable {
    ...
    /// `panel`. Bento uses a deeper sumi-tone; Carbon's barely changes.
...
/// how the chrome *reads* spatially. Bento's signature compartment look
...
/// `String` here so BentoCore stays AppKit-free.
///
