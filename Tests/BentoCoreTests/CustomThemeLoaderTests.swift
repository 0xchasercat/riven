...
struct CustomThemeLoaderTests {
    ...
    private func loader(_ files: [(name: String, body: String)]) throws -> (CustomThemeLoader, URL) {
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("bento-theme-tests-\(UUID().uuidString)", isDirectory: true)
    ...
    func missingDirectory() {
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("bento-missing-\(UUID().uuidString)", isDirectory: true)
    ...
    func seedDefaultTemplate() throws {
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("bento-theme-seed-\(UUID().uuidString)", isDirectory: true)
