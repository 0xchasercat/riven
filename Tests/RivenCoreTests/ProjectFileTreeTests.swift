...
struct ProjectFileTreeTests {
    ...
    func scansProjectTree() throws {
        ...
        try FileManager.default.createDirectory(at: root.appendingPathComponent("Sources/Riven"), withIntermediateDirectories: true)
        ...
        try "app".write(to: root.appendingPathComponent("Sources/Riven/App.swift"), atomically: true, encoding: .utf8)
        ...
        #expect(tree.children[0].children.map(\.name) == ["Riven"])
